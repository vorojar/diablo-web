...
- **套装系统**:
  - 🟢 **塔拉夏的外袍**: 法师专属套装，强化法力（2件: 全抗+50 | 4件: 法力回复+100%, MP+60 | 6件: 火伤+200, 暴击+10%）
  - 🟢 **不朽之王**: 战士专属套装，强化物理攻击（2件: HP+100 | 4件: 吸血+10%, 攻速+30% | 6件: 伤害+450%, 防御+150）
  - 🟢 **暗影舞者**: 刺客专属套装，强化暴击和攻速（2件: 攻速+30% | 4件: 暴伤+75%, 暴击+10% | 6件: 暴击+35%, 伤害+150%）
