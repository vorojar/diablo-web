...
- **v3.4**:
  - **UI 对齐修复**: 修复了自动战斗图标和设置按钮垂直对齐的问题，界面更加整洁。

- **v3.5**:
  - **快捷栏显示修复**: 
    - 修复了快捷栏物品数量和快捷键提示被物品图标遮挡的问题。
    - 优化了 DOM 元素的层级关系 (z-index)，确保数字始终在图标上方显示。


- **v3.6**:
  - **严重 Bug 修复**: 修复了回城传送门在罗格营地可能生成在墙壁边缘导致玩家卡死的问题。现在传送门会生成在距离墙壁至少 2 个格子的安全区域内。
