...
Assert-Contains -Text $autoBattle -Pattern 'canMeleeTarget\(target, dist, hasLOS\)' -Message 'FAIL: AutoBattle attack decision should use the unified melee predicate.'
